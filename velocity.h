...
public:
   ...
   // getters
   virtual double getDX()       const { return this->dx; }
   virtual double getDY()       const { return this->dy; }
   ...
   virtual void addV(const Velocity & rhs) { this->dx += rhs.getDX(); this->dy += rhs.getDY(); }
   virtual void reverse() { dx = dx * -1.0; dy = dy * -1.0; }
