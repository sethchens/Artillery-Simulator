...
private:
   ...
   void setDxDy_right()
   {
      ...
      // verify
      assertEquals(a.radians * 180.0 / M_PI, 90.0);
   } // teardown
   ...
   void setDxDy_left()
   {
      ...
      // verify
      assertEquals(a.radians * 180.0 / M_PI, 270.0);
   }
   ...
   {  // setup
      ...
      // verify
      tolerance  = 0.001;
      assertEquals(a.radians * 180.0 / M_PI, 30.0);
   }  // teardown
